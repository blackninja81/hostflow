...
import { MoreVertical, Edit3, Trash2, Box, Banknote, AlertTriangle, X } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm z-[999] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 w-full max-w-md shadow-2xl border border-gray-100 dark:border-slate-800 animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-xl font-black text-[#484848] dark:text-white tracking-tight">Edit Supply</h3>
                <p className="text-[10px] font-black text-[#008489] uppercase tracking-widest mt-1">{item.name}</p>
              </div>
              <button onClick={() => setIsEditing(false)} className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <X size={20} />
              </button>
            </div>
